...
type
  TfrmZynDialog = class(TForm)
    ...
    procedure VST3Expanding(Sender: TBaseVirtualTree; Node: PVirtualNode;
      var Allowed: Boolean);
...
procedure TfrmZynDialog.VST3InitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode; var ChildCount: Cardinal);
var
	Data: PNodeInfoRec;
begin
    ChildCount := 5;
...
procedure TfrmZynDialog.VST3InitNode(Sender: TBaseVirtualTree; ParentNode, Node: PVirtualNode;
  var InitialStates: TVirtualNodeInitStates);
...
procedure TfrmZynDialog.VST3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
    Node: PVirtualNode;
	Data: PNodeInfoRec;
...
procedure TfrmZynDialog.VST3KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmZynDialog.VST3GetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex;
...
procedure TfrmZynDialog.VST3GetHint(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex;
  var LineBreakStyle: TVTTooltipLineBreakStyle; var HintText: string);
var
     Data: PNodeInfoRec;
begin
...
procedure TfrmZynDialog.VST3GetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind;
...
procedure TfrmZynDialog.VST3Editing(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
...
procedure TfrmZynDialog.VST3Expanding(Sender: TBaseVirtualTree;
...
procedure TfrmZynDialog.VST3Change(Sender: TBaseVirtualTree; Node: PVirtualNode);
...
procedure TfrmZynDialog.VST3CreateEditor(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex;
...
procedure TfrmZynDialog.VST3PaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode;
  Column: TColumnIndex; TextType: TVSTTextType);
...
procedure TfrmZynDialog.VST3IncrementalSearch(Sender: TBaseVirtualTree; Node: PVirtualNode; const SearchText: string;
  var Result: Integer);
...
procedure TfrmZynDialog.VST3StateChange(Sender: TBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
...
procedure TfrmZynDialog.VST3FreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
var
    Data: PNodeInfoRec;
begin
    Data := Sender.GetNodeData(Node);
