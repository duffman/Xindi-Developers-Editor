...
type
	TZynNodeType = (ntUnset, ntRoot, ntFile, ntDir, ntDirUp);
    ...
    public
        ...
        ****************************}
        ...
        property NodeType: TZynNodeType read FNodeType;
...
//  Set Path
//
function TZynTreeNode.SetPath(AValue: String): TZynTreeNode;
begin
    Result := Self;
...
//  Set Filename
//
function TZynTreeNode.SetFilename(AValue: String): TZynTreeNode;
begin
	Result := Self;
